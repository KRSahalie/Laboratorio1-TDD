...
HD_PWD='C:/Users/prisc/TallerDD/laboratorio1-grupo-6/ejercicio1/LAB1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log abc.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source abc.tcl -notrace
