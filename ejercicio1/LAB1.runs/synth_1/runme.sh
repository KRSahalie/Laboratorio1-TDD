...
HD_PWD='C:/Users/prisc/TallerDD/laboratorio1-grupo-6/ejercicio1/LAB1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log abc.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source abc.tcl
